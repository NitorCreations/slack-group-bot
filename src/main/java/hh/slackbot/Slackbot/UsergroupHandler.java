...
public class UsergroupHandler {
	...
	*/
	public static Response handleUsergroupCommand(SlashCommandRequest req, SlashCommandContext ctx) {
        ...
        // Messager.help(message);   // <----------------------------------------IMPORTANT!!!
    }
    ...
    */
    private static String finalizeUsergroupCommand(String userId, String command, String usergroupName) {
        ...
        // TRUE: if the user group exists, and the command was "join" --> joining is possible
        // TRUE: if the user group does NOT exist, but the command was "join" --> the group is created
        // FALSE: if the user group is null AND the command was "leave" --> can't leave a non-existing group
	...
	public static String addUserToGroup(String userId, Usergroup group) {
	    ...
	    if (UsergroupUtil.userInGroup(group, userId, users)) {
	...
	public static String removeUserFromGroup(String userId, Usergroup group) {
        ...
        // If the modifiedUsers is empty (a.k.a. only the leaving user is in the group)...
        ...
        // If the leaving goes well, the following String is returned to finalizeUsergroupCommand
