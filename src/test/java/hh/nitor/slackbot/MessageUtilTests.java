...
public class MessageUtilTests {
	...
	public void directMessageIoException() throws IOException, SlackApiException {
		when(client.chatPostMessage(any(ChatPostMessageRequest.class))).thenThrow(new IOException());
	...
	public void ephemeralMessageBuiltRight() throws IOException, SlackApiException {
		...
		Assertions.assertTrue(req.getChannel().equals(channelId), "Request channel matches input channel ID");
	}
	...
	public void ephemeralMessageIoException() throws IOException, SlackApiException {
		when(client.chatPostEphemeral(any(ChatPostEphemeralRequest.class))).thenThrow(new IOException());
